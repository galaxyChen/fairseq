...
@register_model('adv_transformer_distill')
class AdvTransformerDistillModel(FairseqEncoderDecoderModel):
    """
    ...
    def __init__(self, args, encoder, decoder):
        ...
        self.teacher = self.load_teacher_model(args)
    ...
    def add_args(parser):
        ...
        parser.add_argument('--teacher-path', default=None,
                            help="the path to teacher model")
        # fmt: on
    ...
    def forward(self, src_tokens, src_lengths, prev_output_tokens, embed=None, **kwargs):
        ...
        self.teacher.eval()
        teacher_output = self.teacher(src_tokens, src_lengths, prev_output_tokens,
                                      "en", "ja")
        return decoder_out, teacher_output
...
@register_model_architecture('adv_transformer_distill', 'adv_transformer_distill')
